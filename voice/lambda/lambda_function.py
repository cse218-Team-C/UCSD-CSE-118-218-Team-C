...
class HelloWorldIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("PlantWateringIntent")(handler_input)

    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        MOISTURE_URL = "http://randomly-verified-jaguar.ngrok-free.app/moisture"
        needs_water_raw = requests.get(MOISTURE_URL)
